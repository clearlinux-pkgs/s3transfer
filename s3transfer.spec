...
%prep
%setup -q -n s3transfer-0.3.3
cd %{_builddir}/s3transfer-0.3.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1581053409
...
cp %{_builddir}/s3transfer-0.3.3/LICENSE.txt %{buildroot}/usr/share/package-licenses/s3transfer/5a7d7df655ba40478fae80a6abafc6afc36f9b6a
