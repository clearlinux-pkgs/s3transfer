...
Source0  : https://files.pythonhosted.org/packages/0f/c2/266326b601256b5722aea10961504857f324cd50f4adc66a2f573fbea017/s3transfer-0.3.6.tar.gz
...
%prep
%setup -q -n s3transfer-0.3.6
cd %{_builddir}/s3transfer-0.3.6
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1616165916
...
cp %{_builddir}/s3transfer-0.3.6/LICENSE.txt %{buildroot}/usr/share/package-licenses/s3transfer/5a7d7df655ba40478fae80a6abafc6afc36f9b6a
