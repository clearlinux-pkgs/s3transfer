...
%prep
%setup -q -n s3transfer-0.4.2
cd %{_builddir}/s3transfer-0.4.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1619146148
...
cp %{_builddir}/s3transfer-0.4.2/LICENSE.txt %{buildroot}/usr/share/package-licenses/s3transfer/5a7d7df655ba40478fae80a6abafc6afc36f9b6a
