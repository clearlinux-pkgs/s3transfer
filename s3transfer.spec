...
Source0  : https://files.pythonhosted.org/packages/08/e1/3ee2096ebaeeb8c186d20ed16c8faf4a503913e5c9a0e14cd6b8ffc405a3/s3transfer-0.3.4.tar.gz
...
%prep
%setup -q -n s3transfer-0.3.4
cd %{_builddir}/s3transfer-0.3.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1610469054
...
cp %{_builddir}/s3transfer-0.3.4/LICENSE.txt %{buildroot}/usr/share/package-licenses/s3transfer/5a7d7df655ba40478fae80a6abafc6afc36f9b6a
