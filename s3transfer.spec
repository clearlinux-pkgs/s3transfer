...
Source0  : https://files.pythonhosted.org/packages/63/1b/541c480e6ace294537cf33786363e4dc54823c6f0b25bf03c1685c00218f/s3transfer-0.3.2.tar.gz
...
%prep
%setup -q -n s3transfer-0.3.2
cd %{_builddir}/s3transfer-0.3.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1579884214
...
cp %{_builddir}/s3transfer-0.3.2/LICENSE.txt %{buildroot}/usr/share/package-licenses/s3transfer/5a7d7df655ba40478fae80a6abafc6afc36f9b6a
