...
Source0  : https://files.pythonhosted.org/packages/f8/27/b65041a2e68ce4ad9e51622f630f2be356d7e1ff1bfef687dde07e4a3d26/s3transfer-0.4.0.tar.gz
...
%prep
%setup -q -n s3transfer-0.4.0
cd %{_builddir}/s3transfer-0.4.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1618931165
...
cp %{_builddir}/s3transfer-0.4.0/LICENSE.txt %{buildroot}/usr/share/package-licenses/s3transfer/5a7d7df655ba40478fae80a6abafc6afc36f9b6a
