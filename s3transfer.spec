...
Source0  : https://files.pythonhosted.org/packages/b2/45/5f8817a68b5128f9c9ee2259412de4fccf0dbce4220bf9ba703285232231/s3transfer-0.3.1.tar.gz
...
%prep
%setup -q -n s3transfer-0.3.1
cd %{_builddir}/s3transfer-0.3.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1579278586
...
cp %{_builddir}/s3transfer-0.3.1/LICENSE.txt %{buildroot}/usr/share/package-licenses/s3transfer/5a7d7df655ba40478fae80a6abafc6afc36f9b6a
