...
Source0  : https://files.pythonhosted.org/packages/66/f5/5ca537483fa5e96fbd455f52a69fc70c5f659f7e8c9189a1dbc211e1ccf9/s3transfer-0.3.7.tar.gz
...
%prep
%setup -q -n s3transfer-0.3.7
cd %{_builddir}/s3transfer-0.3.7
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1618413149
...
cp %{_builddir}/s3transfer-0.3.7/LICENSE.txt %{buildroot}/usr/share/package-licenses/s3transfer/5a7d7df655ba40478fae80a6abafc6afc36f9b6a
